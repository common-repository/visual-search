...
class Client implements ClientInterface
{
     ...
     *
     * @see \ImpreseeGuzzleHttp\RequestOptions for a list of available request options.
     */
     ...
     *                       request and to the transfer. See \ImpreseeGuzzleHttp\RequestOptions.
     *
     * @return Promise\PromiseInterface
     */
     ...
     * @param array               $options Request options to apply. See \ImpreseeGuzzleHttp\RequestOptions.
     *
     * @return Promise\PromiseInterface
     */
     ...
     *
     * @param array $options See \ImpreseeGuzzleHttp\RequestOptions.
     *
     * @return Promise\PromiseInterface
     */
