...
use ImpreseeGuzzleHttp\Handler\CurlHandler;
...
function choose_handler()
{
    ...
    if (ini_get('allow_url_fopen')) {
        ...
        throw new \RuntimeException('ImpreseeGuzzleHttp requires cURL, the '
...
function default_user_agent()
{
    ...
    if (!$defaultAgent) {
        $defaultAgent = 'ImpreseeGuzzleHttp/' . Client::VERSION;
